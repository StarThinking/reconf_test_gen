...
# Hadoop Common
## Default Configuration and Listener
...
# let maven download it
rm /root/.m2/repository/org/apache/hadoop/hadoop-common/2.8.5/*.jar
#cp /root/hadoop-2.8.5-src/hadoop-common-project/hadoop-common/target/*.jar /root/.m2/repository/org/apache/hadoop/hadoop-common/2.8.5/
